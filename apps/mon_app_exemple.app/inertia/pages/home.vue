      ...
      >
        <div class="relative opacity-80">
          <svg fill="none" viewBox="0 0 240 105">
            <path d="M0 4a4 4 0 0 1 4-4h232a4 4 0 0 1 4 4v101H0V4Z" fill="#F9F9F8" />
            ...
            <rect fill="#DAD9D6" height="3" rx="1" width="8" x="162" y="9.944" />
            <rect fill="#DAD9D6" height="3" rx="1" width="14" x="174" y="9.944" />
            <rect fill="#DAD9D6" height="3" rx="1" width="10" x="192" y="9.944" />
            <rect fill="#DAD9D6" height="3" rx="1" width="10" x="206" y="9.944" />
            <rect fill="#DAD9D6" height="6" rx="2" width="81" x="24" y="32" />
            <rect fill="#DAD9D6" height="6" rx="2" width="95" x="24" y="44" />
            <rect fill="#21201C" height="5" rx="1" width="16" x="24" y="60" />
            <path d="M24 85a4 4 0 0 1 4-4h184a4 4 0 0 1 4 4v20H24V85Z" fill="#DAD9D6" />
            <path
            ...
            <defs>
              ...
              <clipPath id="a">
                <path d="M24 6h36.307v10.889H24z" fill="#fff" />
              </clipPath>
            </defs>
          </svg>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        >
          <h2 class="font-semibold text-sand-12">
            <a class="flex flex-row gap-2" href="https://lucid.adonisjs.com" target="_blank">
        ...
        >
          <h2 class="font-semibold text-sand-12">
            <a class="flex flex-row gap-2" href="https://vinejs.dev/" target="_blank">
        ...
        >
          <h2 class="font-semibold text-sand-12">
            <a class="flex flex-row gap-2" href="https://inertiajs.com/" target="_blank">
        ...
        >
          <h2 class="font-semibold text-sand-12">
            <a class="flex flex-row gap-2" href="https://japa.dev" target="_blank">
